...
import { INCLUDED_STATUSES, PROVINCE_CODE, REGION_TABLE } from "./sources";
...
async function main(): Promise<void> {
  ...
  console.log(`[build-indicators] wrote manifest.json (${Object.keys(manifestIndicators).length} indicators)`);
}
